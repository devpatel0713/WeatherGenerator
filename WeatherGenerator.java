...
public class WeatherGenerator {
     ...
     * return:
     *      this method does y return data. The method is used to populate two 1D arrays of length
    ...
    public static int[] forecastGenerator( double drywetProbability, double wetwetProbability, int numberOfDays) {
        ...
        //System.out.println(drywetProbability + wetwetProbability + numberOfDays);
        ...
        //System.out.println("The First day "+forecast[0]+ "prob "+num1);
        ...
        for( int day = 1; day < forecast.length; day++){
            ...
            //System.out.println(forecast[day]);
    ...
    public static int[] oneMonthForecast(int numberOfLocations, int month, double longitude, double latitude ){
        ...
        //System.out.println(drywetProbability  +  " "  + wetwetProbability);
